...
export const ServicesGridClient: React.FC<ServicesGridClientProps> = ({
  heading,
  subheading,
  services,
}) => {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          {services?.map((service, index) => {
            ...
            return (
              <ScrollAnimation key={service.slug} animation="fade-in-up" delay={index * 150}>
                <div
                  className={cn(
                    'group relative h-full flex flex-col rounded-2xl bg-white border',
                    isPopular
                      ? 'border-warmGold shadow-glow-gold'
